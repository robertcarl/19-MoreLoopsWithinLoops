...
def run_test_largest_number():
    ...
    expected = 25
    answer = largest_number(([1, 5, 24, 11], [2, 4, 6, 8, 10], [-24, 23, 25, 20]))
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    expected = -3
    answer = largest_negative_number(([1, 4, 5, 6, -9], [2, 12, 22, -3, -5], [-3, -5, -7, -9, -20]))
    print('Expected and actual are:', expected, answer)

    expected = None
    answer = largest_negative_number(([4, 5, 6, 7, 8], [15, 22, 19, 11, 1], [0, 1, 0, 0, 1]))
    print('Expected and actual are:', expected, answer)

    expected = -1
    answer = largest_negative_number(([3, 6, 9000], [-2, -2, -2, -2, -2], [-1]))
    print('Expected and actual are:', expected, answer)
...
def largest_negative_number(seq_seq):
    ...
    # -------------------------------------------------------------------------
    highest = -999999999999999999999999999999999
    for k in range(len(seq_seq)):
        for j in range(len(seq_seq[k])):
            if seq_seq[k][j] < 0:
                if seq_seq[k][j] > highest:
                    highest = seq_seq[k][j]
    if highest == -999999999999999999999999999999999:
        return None
    else:
        return highest
